...
DEPENDS += "hal-cm hal-dhcpv4c hal-ethsw hal-moca hal-mso_mgmt hal-mta hal-platform hal-vlan hal-wifi libnetfilter-queue libupnp cjson halinterface cimplog libevent libsyswrapper"
...
do_install_append () {
    ...
    { echo "3 erouter" ; echo "4 all_lans" ; echo "6 moca" ; } > ${D}${sysconfdir}/iproute2/rt_tables.d/rdkb.conf
