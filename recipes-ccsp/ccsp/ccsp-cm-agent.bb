...
DEPENDS += "utopia hal-cm hal-platform libunpriv"
...
do_compile_prepend () {
	( /usr/bin/python ${STAGING_BINDIR_NATIVE}/dm_pack_code_gen.py ${S}/${DATAMODEL_XML} ${S}/source/CMAgentSsp/dm_pack_datamodel.c )
}
