...
DEPENDS += "hal-cm hal-dhcpv4c hal-ethsw hal-moca hal-mso_mgmt hal-mta hal-platform hal-vlan hal-wifi utopia cimplog libparodus telemetry avro-c util-linux"
