...
DEPENDS += "utopia hal-cm hal-dhcpv4c hal-ethsw hal-mso_mgmt hal-platform ccsp-hotspot ccsp-lm-lite telemetry ccsp-hotspot ccsp-misc cimplog cjson curl libparodus libsyswrapper libunpriv msgpack-c openssl nanomsg trower-base64 wrp-c"
